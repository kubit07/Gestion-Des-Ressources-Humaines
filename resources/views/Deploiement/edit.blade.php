...
<h2 style="font-family: Monotype Corsiva; text-shadow: 0px 5px 5px #f7d204;">Muter l'Agent : {{$deploiement->agent->nomAgent}} {{$deploiement->agent->prenomAgent}} </h2>

<form method="post" action="{{route('deploiement.deploiement.update',$deploiement)}}" enctype="multipart/form-data">
    ...
    <div style="font-variant: small-caps; font-weight: bold;">
        ...
        <div class="form-group">
                ...
                placeholder="Rentrer le numéro de détachement...." id="nunDetachement" value="{{old('nunDetachement') ?? $deploiement->nunDetachement}}">
