...
<h3 style="font-family: Monotype Corsiva; color : #1d52d6 !important;">Liste des Agents/Conjoints illégitimes/Enfants</h3>
...
<hr>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Liste des Agents/Conjoints illégitimes/Enfants</div>
                <div class="card-body">
